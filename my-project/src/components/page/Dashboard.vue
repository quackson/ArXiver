 ...
 data() {
	 /*
      const item = {
        paper: 'paperNo.1',
        author: 'xxx',
        description: '测试用推荐论文描述测试用推荐论文描述测试用推荐论文描述测试用推荐论文描述'
      };
	  const item2={
		 paper: 'paperNo.2',
         author: 'xxx',
...
    },
	...
	created(){
		...
		let _this = this
        this.$http.request({
          url:_this.$url + '/searchPaper?method=ti&query=stackoverflow',
          method:'get',
